...
function(internal_compile_library)
	...
	set(VALUES "NAME" "OBJECT_ALIAS_NAME" "INDEPENDENT_OBJECT_ALIAS_NAME"
		...
		"SHARED_INSTALL_PATH" "STATIC_INSTALL_SUBDIR" "SHARED_INSTALL_SUBDIR")
	...
	if(FLAME_INSTALL)
		...
		if(FLAME_LOCAL_INSTALL)
			set(STATIC_INSTALL_PREFIX
				${FLAME_LOCAL_INSTALL_PREFIX}/${FLAME_INSTALL_STATIC_DIR})
			set(COMPILE_STATIC_INSTALL_PATH
				${STATIC_INSTALL_PREFIX}/${COMPILE_STATIC_INSTALL_SUBDIR})
		elseif(NOT HEADER_INSTALL_PATH)
			set(STATIC_INSTALL_PREFIX
				${CMAKE_INSTALL_PREFIX}/${FLAME_INSTALL_STATIC_DIR})
			set(COMPILE_STATIC_INSTALL_PATH
				${STATIC_INSTALL_PREFIX}/${COMPILE_STATIC_INSTALL_SUBDIR})
		endif()
		...
		if(FLAME_LOCAL_INSTALL)
			set(SHARED_INSTALL_PREFIX
				${FLAME_LOCAL_INSTALL_PREFIX}/${FLAME_INSTALL_SHARED_DIR})
			set(COMPILE_SHARED_INSTALL_PATH
				${SHARED_INSTALL_PREFIX}/${COMPILE_SHARED_INSTALL_SUBDIR})
		elseif(NOT HEADER_INSTALL_PATH)
			set(SHARED_INSTALL_PREFIX
				${CMAKE_INSTALL_PREFIX}/${FLAME_INSTALL_SHARED_DIR})
			set(COMPILE_SHARED_INSTALL_PATH
				${SHARED_INSTALL_PREFIX}/${COMPILE_SHARED_INSTALL_SUBDIR})
		endif()
	endif()

#	if(COMPILE_NOT_MAKE_POSITION_DEPENDENT_OBJECTS)
#	endif()

#	if(COMPILE_NOT_MAKE_POSITION_INDEPENDENT_OBJECTS)
#		if()
#	endif()
...
macro(internal_compile_shared_library)
	...
	internal_add_shared_target_properties(
		...
		IMPLIB_INSTALL_PATH     "${COMPILE_STATIC_INSTALL_PATH}"
		${COMPILE_EXPORT_ALL}
